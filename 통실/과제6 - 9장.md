...
분산분석표 확인 결과, 판매되는 상점(A)의 효과에 대한 유의 확률은 0.6114이고 토양의 질(B)의 효과에 대한 유의 확률은 0.1889로 모두 유의수준 0.05보다 높다. 따라서 파이프의 코팅방법이나 토양의 질에 따라서 파이프의 부식정도에는 유의한 차이가 없다고 할 수 있다.
